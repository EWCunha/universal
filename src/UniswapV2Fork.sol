...
contract UniswapV2Fork is ERC20 {
    ...
    modifier lock() {
        require(unlocked == 1, "UniswapV2Fork: LOCKED");
        unlocked = 0;
        _;
        unlocked = 1;
    }
    ...
    function initialize(address _token0, address _token1) external {
        require(msg.sender == factory, "UniswapV2Fork: FORBIDDEN"); // sufficient check
        token0 = _token0;
        token1 = _token1;
    }
    ...
    function mint(address to) external lock returns (uint liquidity) {
        ...
        require(liquidity > 0, "UniswapV2Fork: INSUFFICIENT_LIQUIDITY_MINTED");
        _mint(to, liquidity);
    ...
    function burn(
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "UniswapV2Fork: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "UniswapV2Fork: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "UniswapV2Fork: INSUFFICIENT_LIQUIDITY"
        );
        ...
        require(
            ...
            "UniswapV2Fork: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
